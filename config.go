...
func init() {
	...
	//
	DB, err = configureDatastoreDB("principal-iris-230413")
	// [END datastore]
	...
	// bucket name.
	//
	StorageBucketName = "principal-iris-230413.appspot.com"
	...
	//
	PubsubClient, err = configurePubsub("principal-iris-230413")
	// [END pubsub]
